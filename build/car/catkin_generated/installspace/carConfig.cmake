...
if("FALSE" STREQUAL "TRUE")
  set(car_SOURCE_PREFIX /home/pi/IMU_Trans/catkin_ws/src/car)
  set(car_DEVEL_PREFIX /home/pi/IMU_Trans/catkin_ws/devel)
  set(car_INSTALL_PREFIX "")
  set(car_PREFIX ${car_DEVEL_PREFIX})
else()
  set(car_SOURCE_PREFIX "")
  set(car_DEVEL_PREFIX "")
  set(car_INSTALL_PREFIX /home/pi/IMU_Trans/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'car' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/IMU_Trans/catkin_ws/install/${idir}'.  ${_report}")
    endif()
